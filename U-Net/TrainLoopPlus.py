...
images, maps = ImLoad('data/epi_norm.tif'), ImLoad('data/epi_train_maps.tif')
...
for epoch in range(20): #loops thru for 10 epochs
    ...
    for i in range(images.shape[0]):
        ...
        img = images[i].reshape([1,1,230,270]) #extracts first training image
        map1 = maps[i].reshape([1,1,230,270]) #extracts first map
