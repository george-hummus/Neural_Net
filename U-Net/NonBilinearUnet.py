...
class Unet(nn.Module):
    ...
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.down4 = Down(512,1024) #outputs 512 channel tensor
        #this is because up bilinear up method doesn't reduce channel size by 2
        #only becomes 1024 in concatenation
        
        self.up1 = Up(1024, 512, bilinear) #outputs 256 channel tensor
        
        self.up2 = Up(512, 256, bilinear) #outputs 128 channel tensor
        
        self.up3 = Up(256, 128, bilinear) #outputs 64 channel tensor
